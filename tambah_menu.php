...
<html lang="en">
 ...
 <!-- Form Registrasi -->
    ...
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="harga_pcs" name="harga">
        </div>
        <div class="form-group">
          <label for="harga1">Deskripsi</label>
          <input type="text" class="form-control" id="deskripsi" name="harga">
        </div>
        <div class="form-group">
          <label for="gambar">Foto Menu</label>
          <input type="file" class="form-control-file border" id="foto" name="gambar">
        </div><br>
  ...
  if(isset($_POST['tambah'])){
    ...
    $stok = $_POST['stok'];
    $harga = $_POST['harga_pcs'];
    $deskripsi = $_POST['deskripsi'];
    $nama_file = $_FILES['foto']['asset'];
    $source = $_FILES['foto']['asset'];
    $folder = './asset';

    move_uploaded_file($source, $folder.$nama_file);
    $insert = mysqli_query($conn, "INSERT INTO menu VALUES (NULL, '$nama', '$jenis','$stok','$harga',  '$deskripsi', '$nama_file')");
